...
import ShadowBatman from '../UI/shadow-batman';
import BatSignalBatman from '../UI/batSignal-batman';
import BusEnterMeanGirls from '../UI/busEnter-meanGirls';
import CrownMeanGirls from "../UI/crown-meanGirls";
import Spiderman from "../UI/spiderman-spiderman";
        ...
        <section className="relative w-full min-h-screen flex items-center overflow-hidden">
            ...
            <div className="flex items-center w-full relative">
                ...
                <div className="w-[30%] ml-15 p-10 h-108 mt-10 flex flex-col justify-start bg-black/80 backdrop-blur-md shrink-0 absolute">
                    ...
                    hover:-translate-y-0.5 hover:shadow-xl transition-all hover:scale-105 z-10`}>
                        <p>Watch Now</p>
                    </Link>
                </div>
